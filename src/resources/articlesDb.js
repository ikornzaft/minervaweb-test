      ...
      paragraphs: [
        {
          descriptor: {
            description:
              'Veremos cómo los números reales surgen de la necesidad de ampliar el campo numérico, especialmente a la hora de incluir a los números irracionales, los cuales no están contemplados en ninguno de los conjuntos que vimos anteriormente.',
          },
        },
        {
          descriptor: {
            description:
              'Muchos de los conceptos y propiedades de estos números ya están explicadas en otras clases (números enteros, fracciones, números decimales), con lo que esta clase servirá de repaso de estos conjuntos y se completará con otros muchos conceptos, como son los intervalos, los errores y los entornos, para finalmente poder llegar al concepto de recta real completa en donde se podrán representar todos los números reales. Introduciremos aquí el concepto de infinito.',
          },
        },
        {
          descriptor: {
            description:
              'Una vez comprendo el funcionamiento de estos números, podremos ver más adelante las sucesiones de números (progresiones aritméticas y geométricas), los límites de sucesiones y los logaritmos.',
          },
        },
        {
          descriptor: {
    ...
    resource: {
      paragraphs: [
        ...
        },
        {
          descriptor: {
            description:
              'Tipos de reproducción asociados a la división celular. Bipartición: es la división de la célula madre en dos células hijas, cada nueva célula es un nuevo individuo con estructuras y funciones idénticas a la célula madre. Este tipo de reproducción la presentan organismos como bacterias, amebas y algas. Gemación: se presenta cuando unos nuevos individuos se producen a partir de yemas. El proceso de gemación es frecuente en esponjas, celentereos y briozoos. En una zona son varias del organismo progenitor se produce una envaginación o yema que se va desarrollando y en un momento dado sufre una constricción en la base y se separa del progenitor comenzando su vida como nuevo ser. Las yemas hijas pueden presentar otras yemas a las que se les denomina yemas secundarias.',
          },
        },
        {
          descriptor: {
